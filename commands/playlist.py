...
class Command_Playlist(commands.Cog):
    ...
    async def send_playlist(self, ctx):
        for lista in listas:
    ...
    async def send_play(self, ctx, message=None):
...
async def setup(client):
    await client.add_cog(Command_Playlist(client))
